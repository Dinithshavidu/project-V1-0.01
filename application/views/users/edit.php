        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <form method="post" action="<?php echo base_url('user/useredit'); ?>">
                                <input type="hidden" name="user_updateid"
                            ...
                            <input type="hidden" name="user_crid" value="<?php echo $_SESSION['passed_user_national'] ?>"  /> -->
                                <div class="form-group">
                                    ...
                                    <select id="get_user_list" name="get_user_list" onchange="load_director()"
                                        ...
                                        <option selected disabled>Select User NIC</option>
                                        <?php

                                        foreach ($retrieveUserNic as $get_nic) {
                                            ?>
                                            <option value="<?php echo $get_nic->user_nic; ?>">
                                                <?php echo $get_nic->user_nic; ?> &nbsp; - &nbsp;<?php echo $get_nic->user_name; ?>
                                            </option>
                                        <?php
                                        }
                                        ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="user_eno" name="user_eno"
                                    placeholder="Employee ID" required>
                            </div>

                            <div class="form-group">
                                <label for="user_tpno">Mobile Number</label>
                                <input type="text" class="form-control" id="user_tpno" name="user_tpno"
                  ...
                  <select id="user_role" name="user_role" style="width: 100%;">
                    ...
                    <option> Alaska</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="user_note" name="user_note"
                            ...
                            <div class="form-group" align='right'>
                                ...
                                <button type="submit" value="edit_user" name="edit_user" class="btn btn-primary">Save
                                    User</button>
                            </div>
                        </div>
