              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url('customer/newcustomerinsert'); ?>">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <textarea class="form-control" rows="3" id="cust_address" name="cust_address" placeholder="Enter ..." ></textarea>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <textarea class="form-control" rows="3" id="cust_note" name="cust_note" placeholder="Enter ..." ></textarea>                      
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
