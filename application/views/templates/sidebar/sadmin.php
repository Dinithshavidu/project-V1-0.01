      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="#" class="nav-link">
            ...
            <p>Attendence Managment </p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo base_url(); ?>portal/employee/action/employe_process" class="nav-link">
        ...
        <li class="nav-item">
          <a href="<?php echo base_url(); ?>portal/employee/action/employee_data" class="nav-link">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>portal/setup/action/setup_emp" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Employee Maangement</p>
              </a>
            </li>
        ...
        <li class="nav-item">
          <a href="#" class="nav-link">
            <i class="fa fa fa-user-circle nav-icon"></i>
